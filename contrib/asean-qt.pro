...
RESOURCES += src/qt/asean.qrc src/qt/asean_locale.qrc

TRANSLATIONS += src/qt/locale/asean_bg.ts \
                src/qt/locale/asean_de.ts \
                src/qt/locale/asean_en.ts \
                src/qt/locale/asean_es.ts \
                src/qt/locale/asean_fi.ts \
                src/qt/locale/asean_fr.ts \
                src/qt/locale/asean_it.ts \
                src/qt/locale/asean_ja.ts \
                src/qt/locale/asean_pl.ts \
                src/qt/locale/asean_pt.ts \
                src/qt/locale/asean_ru.ts \
                src/qt/locale/asean_sk.ts \
                src/qt/locale/asean_sv.ts \
                src/qt/locale/asean_vi.ts \
                src/qt/locale/asean_zh_CN.ts \
                src/qt/locale/asean_zh_TW.ts
