...
This means one can have an always-on aseand instance running, and another local aseand/asean-qt instance which connects to this node and receives blocks from it.
