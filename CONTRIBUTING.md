Contributing to Asean Core
==================================

The Asean Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Asean Core project, and is not to be
confused with overall Asean Network Protocol consensus changes.

Whether a pull request is merged into Asean Core rests with the project merge
...
Patches that change Asean consensus rules are considerably more involved than
...
Where a patch set proposes to change the Asean consensus, it must have been
...
The project leader is the release manager for each Asean Core release.
