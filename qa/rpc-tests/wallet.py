...
#   c) node1 mines 32 blocks, so now node 0 has 500000ACCH, node 1 has 4250ACCH, node2 has none.
#   d) node0 sends 601 ACCH to node2, in two transactions (301 ACCH, then 300 ACCH).
