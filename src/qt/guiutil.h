...
/** Utility functions used by the Asean Qt UI.
 */
namespace GUIUtil
{
...
// Render ACCH addresses in monospace font
...
// Parse "asean:" URI into recipient object, return true on successful parsing
