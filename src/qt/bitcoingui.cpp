                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Asean Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ACCH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and asean: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Asean Core"), this);
    aboutAction->setStatusTip(tr("Show information about Asean Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Asean"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ACCH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ACCH addresses"));
    ...
    openAction->setStatusTip(tr("Open a asean: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Asean Core help message to get a list with possible Asean command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Asean Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Asean network", "", count));
}
...
{
    QString strTitle = tr("Asean Core"); // default title
