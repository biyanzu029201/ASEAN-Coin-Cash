...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Asean features */
        {"asean", "masternode", &masternode, true, true, false},
        {"asean", "listmasternodes", &listmasternodes, true, true, false},
        {"asean", "getmasternodecount", &getmasternodecount, true, true, false},
        {"asean", "masternodeconnect", &masternodeconnect, true, true, false},
        {"asean", "masternodecurrent", &masternodecurrent, true, true, false},
        {"asean", "masternodedebug", &masternodedebug, true, true, false},
        {"asean", "startmasternode", &startmasternode, true, true, false},
        {"asean", "createmasternodekey", &createmasternodekey, true, true, false},
        {"asean", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"asean", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"asean", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"asean", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"asean", "getmasternodescores", &getmasternodescores, true, true, false},
        {"asean", "mnbudget", &mnbudget, true, true, false},
        {"asean", "preparebudget", &preparebudget, true, true, false},
        {"asean", "submitbudget", &submitbudget, true, true, false},
        {"asean", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"asean", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"asean", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"asean", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"asean", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"asean", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"asean", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"asean", "checkbudgets", &checkbudgets, true, true, false},
        {"asean", "mnsync", &mnsync, true, true, false},
        {"asean", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> asean-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23230/\n";
}
