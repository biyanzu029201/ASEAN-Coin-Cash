...
#if defined(NDEBUG)
#error "Asean cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
  ...
  if (nHeight == 0) {
        nSubsidy = 10500000000 * COIN;
    }
    else if (nHeight < 1999 && nHeight > 0) {
        nSubsidy = 50 * COIN;
    }
    else if (nHeight <= 3999 && nHeight >= 2000) {
        nSubsidy = 55 * COIN;
    }
    else if (nHeight <= 5999 && nHeight >= 4000) {
        nSubsidy = 60 * COIN;
    }
    else if (nHeight <= 7999 && nHeight >= 6000) {
        nSubsidy = 65 * COIN;
    }
    else if (nHeight <= 9999 && nHeight >= 8000) {
        nSubsidy = 70 * COIN;
    }
    else if (nHeight <= 11999 && nHeight >= 10000) {
        nSubsidy = 75 * COIN;
    }
    else if (nHeight <= 13999 && nHeight >= 12000) {
        nSubsidy = 80 * COIN;
    }
    else if (nHeight <= 15999 && nHeight >= 14000) {
        nSubsidy = 85 * COIN;
    }
    else if (nHeight <= 17999 && nHeight >= 16000) {
        nSubsidy = 90 * COIN;
    }
    else if (nHeight <= 19999 && nHeight >= 18000) {
        nSubsidy = 95 * COIN;
    }
    else if (nHeight <= 21999 && nHeight >= 20000) {
        nSubsidy = 100 * COIN;
    }
    else if (nHeight <= 23999 && nHeight >= 22000) {
        nSubsidy = 110 * COIN;
    }
    else if (nHeight <= 24999 && nHeight >= 24000) {
        nSubsidy = 120 * COIN;
    }
    else if (nHeight <= 99999 && nHeight >= 25000) {
        nSubsidy = 2500 * COIN;
    }
    else if (nHeight <= 149000 && nHeight >= 100000) {
        nSubsidy = 2000 * COIN;
    }
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // ACCH: We use certain sporks during IBD, so check to see if they are
