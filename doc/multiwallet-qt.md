...
In order to support loading of multiple wallets in asean-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is asean.cpp.
...
Changes to asean.cpp
----------------------
asean.cpp is the entry point into asean-qt, and as such, will require some minor modifications to provide hooks for
