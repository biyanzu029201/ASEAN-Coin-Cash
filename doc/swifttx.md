...
This mechanism has been integrated into Bitcore-Node-Asean which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/asean/insight-api-asean#web-socket-api](https://github.com/asean/insight-api-asean#web-socket-api)
* API: [https://github.com/asean/insight-api-asean#swifttx-transactions](https://github.com/asean/insight-api-asean#swifttx-transactions)
...
By default, the Asean Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Asean Core daemon:
