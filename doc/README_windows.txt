...
Intro
-----
Asean (ACCH) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Asean utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run asean-qt.exe.

Asean Core is the original Asean client and it builds the backbone of the network.
However, it downloads and stores the entire history of Asean transactions;
